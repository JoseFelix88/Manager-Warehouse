...
public class ControllerProductoAux {
    ...
    public ControllerProductoAux() {
    }

    public ControllerProductoAux(FormProducto formProducto, FormAsignarCUM formAsignarCUM, FormListarPlu flp) {
        ...
        formProducto.lb_AsignaCodigoBarras.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    formProducto.txtCodBarras.setText(codbarras.toString());
        ...
        formAsignarCUM.TB_Presentacion.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            private void tomardatospresentacion() {
                ...
                if (dTO.getEstadocum().equals("ACTIVO")) {
                    ...
                    formProducto.txtmodalidad.setText(tabla.getValueAt(fila, 7).toString());
    ...
    void seteardatos(ProductoDTO dTO) {
        ...
        if (dTO != null) {
            ...
            formProducto.txtcosto.setText("$ " + formatoTexto.numerico(dTO.getCosto()));
    ...
    public ProductoDTO SetearData() {
        ...
        //DATOS CONTABLES & STOCK
        dTO.setCosto(edicion.toNumeroEntero(formProducto.txtcosto.getText()));
        dTO.setPrecioVenta(edicion.toNumeroEntero(formProducto.txtprecioventa.getText()));
        dTO.setCantidadActual(edicion.toNumeroEntero(formProducto.txtstocactual.getText()));
        dTO.setCantiadAvisar(edicion.toNumeroEntero(formProducto.txtstockaviso.getText()));
        dTO.setCantidadMinima(edicion.toNumeroEntero(formProducto.txtstockminimo.getText()));
