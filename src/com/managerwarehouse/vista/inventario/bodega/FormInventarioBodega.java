...
public class FormInventarioBodega extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INVENTARIO GENERAL - BODEGA");
        ...
        TB_detalleinventario.setFont(new java.awt.Font("Verdana", 0, 10)); // NOI18N
        TB_detalleinventario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Plu", "Descripcion", "Inv. Inicial", "Entrada", "Dv. Punto", "Salidas", "Dv. Proveedor", "Sal. Autorizada", "Saldo Final", "Saldo Fisico", "Sobrante", "Faltantes"
            }
        ) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        Object[] key = {JD_fecha1.getDate(), JD_fecha2.getDate()};
        if (key[0] == null) {
            ...
            cargar_inventario();
            gr.diferencia_inventario_Bodega(key);
        }
    ...
    private void cargar_inventario() {
        ...
        if (key[0] == null) {
            ...
            Object[][] rs = idao.Trazabilidad_por_Producto_Bodega(key);
            if (rs != null) {
                edicion.llenarTabla(TB_detalleinventario, rs);
            } else {
                edicion.mensajes(1, "no se encontraron movimientos de inventario "
                        + "dentro del periodo de fechas establecido.");
            }
        }
    }
